...
namespace BlackjackGameLibrary.Game.Round.Commands
{
  public class InitRoundCommand
  {
    ...
    public InitRoundCommand(Dictionary<EPlayers, EPlayerRoundState> playerRoundStates, Dictionary<EPlayers, List<Card>> playerCards, Dictionary<EPlayers, int> playersSumOfCards)
    {
